...
<head>
    <title>Программа Process Hacker</title>
    <meta charset="UTF-8">
    <meta property="og:image" content="https://klondikeitblogger.ga/img/programm/px.jpg">
    <meta property="og:url" content="https://klondikeitblogger.ga/">
    <meta property="og:title" content="Программа Process Hacker. Скачать">
    <meta property="og:description"
        content="Process Hacker - бесплатная утилита с открытым исходным кодом для мониторинга системных процессов и служб. Используемая как замена или дополнение диспетчера задач Windows.">
        ...
        <div class="container">
            ...
            <div class="static">
                <div><img class="view" src="img/view.png" alt=""><span class="vie">Просмотров: <?= $count ?></span>
                    ...
                    <div class="opis">
                        <p id="text21">
                            Process Hacker — бесплатная утилита с открытым исходным кодом для мониторинга системных
                            процессов и служб, запущенных под управлением 32-битных и 64-разрядных операционных систем
                            семейства Windows, используемая как замена или дополнение диспетчера задач Windows.
                        </p>
                        <div class="vozv">
                            <h1>Возможности Process Hacker:</h1>
                        </div>
                        <div class="osob">
                            <li>просмотр статистики процессов;</li>
                            <li>отображение графиков производительности;</li>
                            <li>полная история выполнения процесса;</li>
                            <li>отладка исполняемых программ;</li>
                            <li>просмотр и закрытие сетевых подключений;</li>
                            <li>завершение любых процессов</li>
                        </div>
                    </div>
                </div>
                <a id="ifandonwlod" href="https://verstkag.github.io/filesprog/processhacker-2.39-setup.exe">Скачать
                    сейчас!</a>
                <div class="Driv1 wow animate__animated animate__fadeInRight">
                    <img src="img/largeImg.png" alt="">
                </div>
    </section>
