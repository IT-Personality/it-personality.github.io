...
<head>
    ...
    <meta property="og:image"
        content="https://klondikeitblogger.ga/moreprog/AntiSpy/img/1585740543_2020-04-01_140219.png">
    <meta property="og:url" content="https://klondikeitblogger.ga/">
    <meta property="og:title" content="AntiSpy Скачать">
    <meta property="og:description" content="AntiSpy.exe это часть антишпионской программы Anti-Spy от Neuber. ">
...
<body>
        ...
        <div class="container">
            ...
            <div class="static">
                <div><img class="view" src="img/view.png" alt=""><span class="vie">Просмотров: <?= $count ?></span>
                    ...
                    <div class="opis">
                        <p id="text21">
                            AntiSpy.exe это часть антишпионской программы Anti-Spy от Neuber. Эта программа сканирует
                            ваш компьютер и отслеживает подозрительные программы (программы-шпионы), которые были
                            установлены самостоятельно без вашего разрешения. Программы-шпионы контролируют ваши
                            персональные данные, пароли, поисковые пристрастия и пытаются украсть эту информацию.
                            Остановка или удаление данного модуля может оставить ваш компьютер без защиты от вредоносных
                            программ.
                        </p>
                        <div class="oper">
                ...
                <a id="ifandonwlod" href="https://verstkag.github.io/filesprog/Ashampoo_AntiSpy.exe">Скачать сейчас!</a>
                <div class="Driv1 wow animate__animated animate__fadeInRight">
                    <img src="img/1585740543_2020-04-01_140219.png" alt="">
                </div>
    </section>
    ...
    <script src="js/mi6.js" type="text/javascript"></script>
</body>
