...
<head>
    <title>Программа MiniBin</title>
    <meta charset="UTF-8">
    <meta property="og:image" content="https://klondikeitblogger.ga/img/programm/mini.jpg">
    <meta property="og:url" content="https://klondikeitblogger.ga/">
    <meta property="og:title" content="Программа MiniBin. Скачать">
    <meta property="og:description"
        content="MiniBin - небольшая утилита, которая дополнит Вашу панель уведомлений иконкой Корзины.">
...
<body>
        ...
        <div class="container">
            <div class="photo">
                <div class="DriverTest">
                    <img src="img/Foreman_12981250_6068_icon_60x60.png" alt="">
                </div>
                <div class="iobith1">
                    <h1>MiniBin</h1>
                </div>
            ...
            <div class="static">
                <div><img class="view" src="img/view.png" alt=""><span class="vie">Просмотров: <?= $count ?></span>
                    ...
                    <div class="opis">
                        ...
                        <div class="vozv">
                            <h1>Возможности MiniBin :</h1>
                        </div>
                        <div class="osob">
                            <li>Кликнув два раза по иконке корзины в системном трее её можно полностью очистить.</li>
                            <li>В случае такой необходимости есть возможность настроить то что будет происходит по
                                двойному<br> клику на иконку, например, корзина может не очищаться (установлено по
                                умолчанию), а просто<br> открываться.</li>
                            <li>Можно изменять иконки используемые для отображения корзины в системном трее.</li>
                            <li>Пользователь может включать и отключать индикацию заполнения корзины, звук и
                                некоторые<br> другие параметры.</li>
                        </div>
                        <div class="oper">
                ...
                <a id="ifandonwlod" href="https://verstkag.github.io/filesprog/minibin-6-6-0-0-en-win.zip">Скачать
                    сейчас!</a>
                <div class="Driv1 wow animate__animated animate__fadeInRight">
                    <img src="img/83975865.png" alt="">
                </div>
    </section>
    ...
    <script src="js/ma4.js" type="text/javascript"></script>
</body>
