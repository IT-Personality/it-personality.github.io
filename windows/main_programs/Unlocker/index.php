...
<head>
    ...
    <meta property="og:description"
        content="Бесплатная утилита, позволяющая разблокировать файлы, используемые системным процессом или находящиеся в закрытом доступе.">
        ...
        <div class="container">
            <div class="photo">
                ...
                <div><img class="view" src="img/view.png" alt=""><span class="vie">Просмотров: <?= $count ?></span>
                    ...
                    <p id="text21">
                        Вы когда-нибудь пытались удалить файл, а затем получали ошибку типа «Исходный или конечный файл
                        открыт» или «Файл используется другой программой или пользователем», и вы не можете избавиться
                        от файла? Тогда Unlocker — это ваше решение.<br>Если файл действительно защищен, откроется окно
