...
<head>
    ...
    <meta property="og:description"
        content="С помощью EDS вы можете скрыть и защитить ваши файлы от несанкционированного доступа к ним, поместив их в зашифрованный контейнер. Поддерживаются контейнеры формата VeraCrypt(R), LUKS, EncFs и т.д">
        ...
        <div class="container">
            ...
            <div class="static">
                <div><img class="view" src="img/view.png" alt=""><span class="vie">Просмотров: <?= $count ?></span>
                    ...
                    <div class="opis">
                        <p id="text21">
                            С помощью EDS (Encrypted Data Store) вы можете скрыть и защитить ваши файлы от
                            несанкционированного доступак ним, поместив их в зашифрованный контейнер. Поддерживаются
                            контейнеры формата VeraCrypt(R), LUKS, EncFs, TrueCrypt(R), CyberSafe(R).
                            Чтобы получить доступ к файлам внутри контейнера, можно открыть контейнер во встроенном
                            менеджере файлов EDS, либо можно через EDS присоединить файловую систему контейнера к
                            файловой системе вашего устройства ("смонтировать" контейнер, для этого требуется root
                            доступ к вашему устройству).
                        </p>
                        <div class="vozv">
                            <h1>Возможности EDS:</h1>
                        </div>
                        <div class="osob">
                ...
                <a id="ifandonwlod"
                    href="https://verstkag.github.io/filesprogandroid/1603174597_eds-v2-0-0-243-mod-5mod_ru.apk">Скачать
                    сейчас!</a>
