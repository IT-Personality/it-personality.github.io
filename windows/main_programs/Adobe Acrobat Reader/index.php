...
<head>
    ...
    <meta property="og:image"
        content="https://klondikeitblogger.ga/programs12/Adobe%20Acrobat%20Reader/img/bd05dc22e479cd798fe0613a72093558.jpg">
        ...
        <div class="container">
            ...
            <div class="static">
                <div><img class="view" src="img/view.png" alt=""><span class="vie">Просмотров: <?= $count ?></span>
                    ...
                    <div class="opis">
                        <p id="text21">
                            Adobe Reader для Android - это программа для чтения PDF, которая фокусируется на простоте и
                            скорости . Это приложение не может сделать ничего удивительного, но это позволит вам легко
                            читать даже самые большие PDF-документы. Крайне важно, что он также обладает большой
                            функцией масштабирования и быстрым поиском, что необходимо для того, чтобы попытаться
                            отследить все это на экране с очень маленьким мобильным экраном.
                            <br>
                            Организация документов с помощью Adobe Reader также является приятным опытом - она
                            автоматически обнаруживает PDF-файлы на вашем телефоне и отображает их, когда вы нажимаете
                            кнопку «Открыть», расположенную на верхней панели, которая появляется при касании экрана или
                            через опции меню Adobe Reader. Также в верхней панели Adobe Reader вы можете поделиться
                            документом, который вы читаете.
                        </p>
                        <div class="vozv">
                            <h1>Особенности Adobe Acrobat:</h1>
                        </div>
                        <div class="osob">
                            ...
                            <li>Работа с PDF файлами с использованием жестов Multi-Touch, Pinch zoom, двойное нажатие
                                Zoom, Flick scrolling& Panning.</li>
                        </div>
                    </div>
                </div>
                <a id="ifandonwlod"
                    href="https://verstkag.github.io/filesprogandroid/com-adobe-reader-1923120999-61590211-5e5be50a18321798cf865f57be91c0df.apk">Скачать
                    сейчас!</a>
