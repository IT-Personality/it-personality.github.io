...
<head>
    <title>Программа qBittorrent</title>
    <meta charset="UTF-8">
    <meta property="og:image" content="https://klondikeitblogger.ga/img/programm/q.jpg">
    <meta property="og:url" content="https://klondikeitblogger.ga/">
    <meta property="og:title" content="Программа qBittorrent. Скачать">
    <meta property="og:description"
        content="qBittorrent - бесплатный торрент-клиент для Windows, Mac и Linux, поддерживающий все протоколы и функции P2P-сетей, а также имеющий удобный пользовательский интерфейс.">
        ...
        <div class="container">
            <div class="photo">
                <div class="DriverTest">
                    <img src="img/1573050704_qbittorrent.png" alt="">
                </div>
                <div class="iobith1">
                    <h1>qBittorrent</h1>
                </div>
            ...
            <div class="static">
                <div><img class="view" src="img/view.png" alt=""><span class="vie">Просмотров: <?= $count ?></span>
                    ...
                    <div class="opis">
                        <p id="text21">
                            qBittorrent - бесплатный, мощный и удобный в работе кроссплатформенный клиент файлообменной
                            сети BitTorrent. Несмотря на кажущуюся простоту, программа обладает внушительным набором
                            весьма полезных возможностей,как например наличие интегрированной поисковой системы,
                            расширяемой за счет плагинов, поддержка UPnP/NAT-PMP, встроенный менеджер ограничения
                            скорости, фильтрация по IP, удаленное управление через веб-интерфейс, а также наличие опции
                            последовательной закачки.
                        </p>
                        <div class="vozv">
                            <h1>Возможности qBittorrent :</h1>
                        </div>
                        <div class="osob">
                            <li>Возможность создания торрентов</li>
                            <li>Управление приоритетом и очередью закачки.</li>
                            <li>Менеджер ограничения скорости.</li>
                            <li>Встроенный планировщик.</li>
                            <li>Удаленное управление через веб-интерфейс.</li>
                            <li>Поддержка всех BitTorrent расширений.</li>
                            <li>Расширенный контроль над трекерами, пирами и торрентами.</li>
                        </div>
                        <div class="oper">
                ...
                <a id="ifandonwlod" href="https://verstkag.github.io/filesprog/qbittorrent_4.3.9_x64_setup.exe">Скачать
                    сейчас!</a>
                <div class="Driv1 wow animate__animated animate__fadeInRight">
                    <img src="img/3122-teaser-qbittorrent-4.3.png" alt="">
                </div>
