...
<head>
    <title>Программа Caesium</title>
    <meta charset="UTF-8">
    <meta property="og:image" content="https://klondikeitblogger.ga/moreprog/Caesium/img/caesium-screenshot.jpg">
    <meta property="og:url" content="https://klondikeitblogger.ga/">
    <meta property="og:title" content="Программа Caesium. Скачать">
    <meta property="og:description"
        content="Caesium – это простая программа для сжатия любых изображений на вашем жестком диске так, чтобы они занимали меньше место лишь с минимальной потерей качества.Работает в системах Windows XP и выше (32 и 64 бит).">
        ...
        <div class="container">
            ...
            <div class="static">
                <div><img class="view" src="img/view.png" alt=""><span class="vie">Просмотров: <?= $count ?></span>
                    ...
                    <div class="opis">
                        <p id="text21">
                            Cesium позволяет сжимать изображения до 90% без видимой потери качества. Предоставляя
                            простой, но эффективный интерфейс с предварительным просмотром в режиме реального времени и
                            одновременной обработкой нескольких изображений, каждый сможет достичь наилучшего
                            результата. Опытные пользователи найдут дополнительные функции, такие как параметры хранения
                            метаданных или поддержку структуры папок.
                        </p>
                        <div class="oper">
                ...
                <a id="ifandonwlod" href="https://verstkag.github.io/filesprog/caesium-1-7-0.zip">Скачать сейчас!</a>
                <div class="Driv1 wow animate__animated animate__fadeInRight">
                    <img src="img/caesium-screenshot.jpg" alt="">
                </div>
    </section>
