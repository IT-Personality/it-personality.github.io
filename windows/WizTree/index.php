...
<head>
    <title>Программа WizTree</title>
    <meta charset="UTF-8">
    <meta property="og:image" content="https://klondikeitblogger.ga/img/programm/wiz.jpg">
    <meta property="og:url" content="https://klondikeitblogger.ga/">
    <meta property="og:title" content="Программа WizTree. Скачать">
    <meta property="og:description"
        content="WizTree – бесплатная утилита, которая поможет найти файлы и папки нажестком диске, которые занимают большое количество пространства.">
        ...
        <div class="container">
            <div class="photo">
                <div class="DriverTest">
                    <img src="img/wiztree200x.png" alt="">
                </div>
                <div class="iobith1">
                    <h1>WizTree</h1>
                </div>
            ...
            <div class="static">
                <div><img class="view" src="img/view.png" alt=""><span class="vie">Просмотров: <?= $count ?></span>
                    ...
                    <div class="opis">
                        <p id="text21">
                            WizTree - небольшая и полезная утилита для определения файлов и папок, которые занимают
                            много пространства на жестком диске. Особенностью данного приложения является его высокая
                            производительность анализа дискового пространства благодаря прямому взаимодействию с главной
                            файловой таблицей, которая содержит подробную информацию о содержимом носителя.<br>
                            Интерфейс программы предельно прост и понятен, все необходимые инструменты и функции
                            доступны в главном окне. WizTree работает в автоматическом режиме, активируясь после выбора
                        ...
                        <div class="osob1">
                            <li>Windows 10/8/7/Vista/XP</li>
                        </div>
                    </div>
                </div>
                <a id="ifandonwlod" href="https://verstkag.github.io/filesprog/wiztree_4_04_setup.exe">Скачать
                    сейчас!</a>
                <div class="Driv1 wow animate__animated animate__fadeInRight">
                    <img src="img/wiztree_treeviewwithmap.jpg" alt="">
                </div>
    </section>
