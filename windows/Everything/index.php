...
<head>
    <title>Программа Everything</title>
    <meta charset="UTF-8">
    <meta property="og:image" content="https://klondikeitblogger.ga/img/programm/ee.png">
    <meta property="og:url" content="https://klondikeitblogger.ga/">
    <meta property="og:title" content="Программа Everything. Скачать">
    <meta property="og:description"
        content="Everything — это бесплатная утилита для Windows, позволяющая практически мгновенно находить файлы и папки по их именам, размерам, датам, атрибутам и др.">
        ...
        <div class="container">
            ...
            <div class="static">
                <div><img class="view" src="img/view.png" alt=""><span class="vie">Просмотров: <?= $count ?></span>
                    ...
                    <div class="opis">
                        <p id="text21">
                            Everything - бесплатная и простая в использовании программа для быстрого поиска файлов и
                            папок по их имени.

                            Пользоваться утилитой очень легко - после запуска Everything сканирует ПК и отображает все
                            найденные файлы и каталоги. По мере ввода ключевых слов по которым производится поиск,
                            элементы, которые не соответствуют задаваемым параметрам отсеиваются.
                        </p>
                        <div class="oper">
                ...
                <a id="ifandonwlod" href="https://verstkag.github.io/filesprog/Everything%20x64-Setup.exe">Скачать
                    сейчас!</a>
