...
<head>
    <title>Программа VLC Media Player</title>
    <meta charset="UTF-8">
    <meta property="og:image" content="https://klondikeitblogger.ga/img/programm/wls.jpg">
    <meta property="og:url" content="https://klondikeitblogger.ga/">
    <meta property="og:title" content="Программа VLC Media Player. Скачать">
    <meta property="og:description"
        content="VLC — бесплатный и свободный кросс-платформенный медиаплеер и медиаплатформа с открытым исходным кодом.">
        ...
        <div class="container">
            <div class="photo">
                <div class="DriverTest">
                    <img src="img/1200px-VLC_Icon.svg.png" alt="">
                </div>
                <div class="iobith1">
            ...
            <div class="static">
                <div><img class="view" src="img/view.png" alt=""><span class="vie">Просмотров: <?= $count ?></span>
                    ...
                    <div class="opis">
                        <p id="text21">
                            VLC Media Player это действительно мощный мультимедиа плеер для Windows. Он действительно
                            быстро способен проигрывать все форматы медиафайлов.
                            VLC Media Player нужно всего лишь 3 секунды чтобы быть готовым к работе, вам остается лишь
                            выбрать файл, и VLC воспроизведет его.
                            Он поддерживает MPEG-1, MPEG-2, MPEG-4, DivX, mp3, ogg, ... а также диски DVD, VCD, и
                            некоторые потоковые протоколы.<br>
                            В дополнение ко всему, он способен проигрывать не догруженные файлы, что действительно
                            необходимо, если вы загружаете видео, и хотите убедиться, что качаете действительно то, что
                            нужно.
                            Благодаря всем этим функциям VLC Media Player (ранее известный как VideoLan клиент) стал
                            самым популярным медиаплеером.
                        </p>
                        <div class="oper">
                ...
                <a id="ifandonwlod" href="https://verstkag.github.io/filesprog/vlc-media-player-3-0-16.exe">Скачать
                    сейчас!</a>
                <div class="Driv1 wow animate__animated animate__fadeInRight">
                    <img src="img/vlc_101_w7_2.jpg" alt="">
                </div>
    </section>
